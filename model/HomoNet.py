...
class emb(nn.Module):
    def __init__(self, num_spherical, num_radial, cutoff):
        ...
        self.dist_emb = dist_emb(num_radial, cutoff)
        self.angle_emb = angle_emb(num_spherical, num_radial, cutoff)
...
class HomoNet(torch.nn.Module):
    def __init__(
        ...
        self.cutoff = cutoff
        self.act = nn.SiLU()
        self.emb1 = emb(num_spherical, num_radial, self.cutoff)
