...
class SphereNet(torch.nn.Module):
    def __init__(
        ...
        self.edge_lin = nn.Sequential(Linear(12, hidden_channels), nn.SiLU())
        self.node_lin = nn.Sequential(Linear(48, hidden_channels), nn.SiLU())
    ...
    def forward(self, batch_data):
        x, pos, batch, edge_index, edge_attr = batch_data.z, batch_data.pos, batch_data.batch, batch_data.edge_index, batch_data.edge_attr
